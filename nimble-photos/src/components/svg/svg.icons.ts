export class SvgIcon {
  ...
  static readonly home = SvgIcon.register(
    new SvgIcon('home', SvgIcon.defaultViewBox, [
      'M3 10.5L12 3l9 7.5',
      'M5.25 9.75V21h13.5V9.75',
      'M9.75 21v-6h4.5v6',
    ])
  );
  ...
  static readonly sectionSecurity = SvgIcon.register(
    new SvgIcon('sectionSecurity', SvgIcon.defaultViewBox, [
      'M12 3l7 3v6c0 5-3.4 8.6-7 9-3.6-.4-7-4-7-9V6l7-3z',
      'M9 12l2 2 4-4',
    ])
  );

  static readonly sectionClient = SvgIcon.register(
    new SvgIcon('sectionClient', SvgIcon.defaultViewBox, [
      'M16 11a3 3 0 1 0 0-6 3 3 0 0 0 0 6z',
      'M8 12a3.5 3.5 0 1 0 0-7 3.5 3.5 0 0 0 0 7z',
      'M2.5 19.5c0-2.6 2.3-4.5 5.5-4.5s5.5 1.9 5.5 4.5',
      'M13 19.5c.2-1.8 1.8-3.3 4.2-3.3c2.6 0 4.3 1.6 4.3 3.3',
    ])
  );
